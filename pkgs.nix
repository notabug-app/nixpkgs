...
// prev.lib.optionalAttrs (sys == "aarch64-linux") {
  kernel-rpi4 = final.linuxPackages_rpi4_7_2.kernel;
  cpupower-rpi4 = final.linuxPackages_rpi4_7_2.cpupower;
  kernel-rpi5 = final.linuxPackages_rpi5_7_2.kernel;
  cpupower-rpi5 = final.linuxPackages_rpi5_7_2.cpupower;
